      ...
      >
        ...
        <Grid item justifyContent="center">
          ...
          >
            ...
            <Typography sx={{ fontSize: "1.25rem", marginBottom: "1rem" }}>
              I am currently searching for an opportunity as{" "}
              <b>Web Developer</b>.
            </Typography>
            <Accordion sx={{ boxShadow: "none" }}>
              ...
              <AccordionDetails>
                <Typography sx={{ fontSize: "1.25rem", marginBottom: "1rem" }}>
                  ...
                  internet connection and started to explore the web. This was
                  the time when I have developed my first websites.
                </Typography>
                <Typography sx={{ fontSize: "1.25rem", marginBottom: "1rem" }}>
                  After high school, I decided to continue my education in a
                  college. In 2008 I graduated with a <b>Bachelor's degree</b>{" "}
                  in <b>English and IT</b> and with a <b>Master's degree</b> in
                  2010.
                </Typography>
                <Typography sx={{ fontSize: "1.25rem", marginBottom: "1rem" }}>
                ...
                <Typography sx={{ fontSize: "1.25rem", marginBottom: "1rem" }}>
                  Later, as a self-employed <b>IT instructor</b> (2012 - 2013),
                  I delivered many training for accountants, corporate employees
                  for educational institutions and international companies, e.g.{" "}
                  <Link
                    color="inherit"
                    target="_blank"
                ...
                <Typography sx={{ fontSize: "1.25rem", marginBottom: "1rem" }}>
                  ...
                  , an American Bank for investment funds, where I was
                  processing transactions with accounting applications, working
                  with spreadsheets and <b>automating processes with macros</b>.
                </Typography>
                <Typography sx={{ fontSize: "1.25rem", marginBottom: "1rem" }}>
                ...
                <Typography sx={{ fontSize: "1.25rem", marginBottom: "1rem" }}>
                  ...
                  development. I started to brush up on my web skills and began
                  to learn Javascript. In January 2020 I started a three-month
